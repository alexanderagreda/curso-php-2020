        ...
        <div class="card shadow p-3 mb-5 bg-white rounded">
          <div class="card-body">
            <h3 class="text-center">Formulario</h3>
              <!-- La variable global $_SERVER permite mostrar la ruta del archivo que se ejecuta actualmente -->
              <!-- en su defecto se puede establcer el nombre del archivo actual en la propiedad method de la etiqueta form -->
